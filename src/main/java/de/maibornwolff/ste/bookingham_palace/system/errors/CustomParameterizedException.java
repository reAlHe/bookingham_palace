...
import de.maibornwolff.ste.bookingham_palace.user.api.constants.ErrorConstants;
import static de.maibornwolff.ste.bookingham_palace.system.errors.ErrorConstants.TITLE_PARAMETERIZED_EXCEPTION;
...
public class CustomParameterizedException extends AbstractThrowableProblem {
    ...
    public CustomParameterizedException(String message, Map<String, Object> paramMap) {
        super(DEFAULT_TYPE, TITLE_PARAMETERIZED_EXCEPTION, BAD_REQUEST, null, null, null,
